...
class TestCard:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("banese", "6361171870000127985"),
            ("banese", "6374731870000127985"),
            ("banese", "6374701870000127985"),
            ("banese", "6366591870000127985"),
            ("banese", "6374721870000127985"),
            ("diners", "30346836403940"),
            ("elo", "5041756758046020"),
            ("hipercard", "6062825303833679"),
            ("mastercard", "5369835519963014"),
